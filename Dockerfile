...
LABEL org.opencontainers.image.title="Mobile Device Relay" \
      org.opencontainers.image.description="Access USB-connected iOS devices from Docker containers (macOS and Windows)" \
      ...
      com.docker.extension.screenshots="[{\"alt\":\"Main UI showing relay and tunnel status\",\"url\":\"https://raw.githubusercontent.com/aluedeke/mobile-docker-extension/main/docs/screenshot.png\"}]" \
